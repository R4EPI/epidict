# Getting help with epidict

Thanks for using epidict. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/epidict/issues) to make sure the 
