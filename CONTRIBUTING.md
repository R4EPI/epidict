# Contributing to epidict

This outlines how to propose a change to epidict. For more detailed info
...
Please note that the epidict project is released with a [Contributor
Code of Conduct](https://r4epi.github.io/epidict/CODE_OF_CONDUCT.md). By
